...
GEMINI_API_KEY = os.getenv('GEMINI_API_KEY', 'gen-lang-client-0985146470')

# ✅ ONLY use gemini-1.5-flash - the ONLY reliably free model
GEMINI_MODELS = [
    "gemini-pro"
]
...
def call_gemini_with_fallback(session_data: dict) -> dict:
    """
    Send session data to Gemini API (gemini-1.5-flash only).
