...
# =========================
from session_aggregator import aggregate_session_data, get_gemini_api_key_status, call_gemini_api, get_latest_data_range, validate_time_range
...
def gemini_analyze():
    """
    Send session data to Gemini API for analysis.
    ...
    try:
        ...
        # Call Gemini API
        analysis = call_gemini_api(session_data)
        
        print(f"[OK] GEMINI RESPONSE: health_status={analysis.get('health_status')}, severity={analysis.get('overall_severity')}")
